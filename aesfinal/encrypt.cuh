...
__global__ void Cipher(BYTE *plaintext, int plain_length, BYTE expanded[(ROUNDS+1)*16], int number_of_threads){
    ...
    while (id * 16 < plain_length){
        //printf("start id %d \n",id);
        //Preround
        AES_AddRoundKey(plaintext+id*16, gpu_expanded);
       // printf("pre\n");
   ...
   // printf("\n");
        ...
        for (int r = 1; r<ROUNDS; r++){
            AES_Round(plaintext+id*16, gpu_expanded+r*16, gpu_Sbox, gpu_Mul2);
        }

        //Final Round
        AES_SubBytes(plaintext+id*16, gpu_Sbox);
        //printf("final\n");
        //for(int i=0; i<plain_length; i++){
         //   printf("%02x ", plaintext[i]);
         //   }
        //printf("\n");
       // printf("final shif-row\n");
        AES_ShiftRows(plaintext+id*16);
       // for(int i=0; i<plain_length; i++){
       // printf("%02x ", plaintext[i]);
    //}
    //printf("\n");
        AES_AddRoundKey(plaintext+id*16, gpu_expanded+ROUNDS*16);
        //for(int i=0; i<plain_length; i++){
       // printf("%02x ", plaintext[i]);
   // }
    //printf("\n");
        id = id + number_of_threads;
   // printf("after id %d \n",id);
    }
